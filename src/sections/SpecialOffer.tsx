  ...
  return (
    <Container bgColor="mt-26 xs:mt-45 sm:mt-50 2xl:mt-55 bg-gradient-to-t from-[#ffb883] to-[#ffd0a0]">
      <div className="py-4 xs:py-8 xl:py-15 relative flex items-center">
        <div className="z-1 w-full sm:w-80 md:h-80 md:w-1/2 lg:w-4/9 lg:h-82.5 md:justify-evenly xl:w-[570px] gap-4 xl:gap-8 p-4.5 xl:p-7.5 bg-[#ffffff6d] lg:bg-[#ffffff4d] rounded-3xl flex flex-col items-center justify-center">
